...
try {
    ...
    if (!$otp_data) {
        ...
        // Tapi tetap cek OTP dari database
    ...
    if ($check_phone->fetch()) {
        ...
        echo "<script>alert('Nomor telepon sudah digunakan!'); window.location='../profile.php';</script>";
        exit;
    }
    ...
    echo "<script>alert('Nomor WhatsApp berhasil diubah!'); window.location='../profile.php';</script>";
