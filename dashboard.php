...
require_once _DIR_ . "/functions/auth.php"; 
...
include_once _DIR_ . "/layout/header.php";
include_once _DIR_ . "/layout/sidebar.php";
...
.tab.active { background: #fff; box-shadow: 0 1px 3px rgba(2, 6, 23, 0.06); color: #2563eb; }
                ...
                <tbody id="tasksTbody">
                    ...
                    <tr data-id="<?= $tid ?>" data-title="<?= $title ?>" data-desc="<?= $desc ?>"
                        ...
                        <td class="actions">
                            ...
                            <button class="action-btn delete-btn" onclick="deleteTask(<?= $tid ?>)" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg></button>
                        </td>
                    </tr>
                    <?php endforeach;?>
                    <?php else: ?>
